...
from metavision.config import (
    CLASS_NAME_DATA_FIELD,
    ORIENTED_BOX_COORDINATES,
)
from metavision.detection.lmm import (
    LMM,
    from_florence_2,
    from_paligemma,
...
from metavision.detection.tools.transformers import (
...
from metavision.validators import validate_detections_fields


@dataclass
class Detections:
    """
    The `sv.Detections` class in the Metavision library standardizes results from
    various object detection and segmentation models into a consistent format. This
    class simplifies data manipulation and filtering, providing a uniform API for
    integration with Metavision [trackers](/trackers/), [annotators](/latest/detection/annotators/), and [tools](/detection/tools/line_zone/).

    === "Inference"

        Use [`sv.Detections.from_inference`](/detection/core/#metavision.detection.core.Detections.from_inference)
    ...
    === "Ultralytics"
        ...
        Use [`sv.Detections.from_ultralytics`](/detection/core/#metavision.detection.core.Detections.from_ultralytics)
        method, which accepts model results from both detection and segmentation models.
    ...
    === "Transformers"
        ...
        Use [`sv.Detections.from_transformers`](/detection/core/#metavision.detection.core.Detections.from_transformers)
        method, which accepts model results from both detection and segmentation models.
    ...
    def with_nmm(
        ...
        ![non-max-merging](https://media.khulnasoft.com/metavision-docs/non-max-merging.png){ align=center width="800" }
        """  # noqa: E501 // docs
        if len(self) == 0:
            return self
