...
from metavision.detection.utils import cross_product
from metavision.draw.color import Color
from metavision.draw.utils import draw_rectangle, draw_text
from metavision.geometry.core import Point, Position, Rect, Vector
from metavision.utils.image import overlay_image
from metavision.utils.internal import MetavisionWarnings
...
class LineZone:
    ...
    <video controls>
        <source
            src="https://media.khulnasoft.com/metavision/cookbooks/count-objects-crossing-the-line-result-1280x720.mp4"
            type="video/mp4">
    </video>
    ...
    def trigger(self, detections: Detections) -> Tuple[np.ndarray, np.ndarray]:
        ...
        if detections.tracker_id is None:
            warnings.warn(
                ...
                "https://metavision.khulnasoft.com/latest/trackers for more "
                "information.",
                category=MetavisionWarnings,
            )
            return crossed_in, crossed_out
