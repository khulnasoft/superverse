...
from metavision.detection.utils import move_boxes, move_masks, move_oriented_boxes
from metavision.utils.image import crop_image
from metavision.utils.internal import (
    MetavisionWarnings,
    warn_deprecated,
)
    ...
    def __init__(
        ...
        if overlap_ratio_wh is not None:
            warn_deprecated(
                ...
                "will be removed in `metavision-0.27.0`. Please manually set it to "
