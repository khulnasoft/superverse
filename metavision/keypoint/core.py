...
from metavision.detection.utils import get_data_item, is_data_equal
from metavision.validators import validate_keypoints_fields


@dataclass
class KeyPoints:
    """
    The `sv.KeyPoints` class in the Metavision library standardizes results from
    various keypoint detection and pose estimation models into a consistent format. This
    class simplifies data manipulation and filtering, providing a uniform API for
    integration with Metavision [keypoints annotators](/latest/keypoint/annotators).

    === "Ultralytics"

        Use [`sv.KeyPoints.from_ultralytics`](/latest/keypoint/core/#metavision.keypoint.core.KeyPoints.from_ultralytics)
    ...
    === "Inference"
        ...
        Use [`sv.KeyPoints.from_inference`](/latest/keypoint/core/#metavision.keypoint.core.KeyPoints.from_inference)
    ...
    === "MediaPipe"
        ...
        Use [`sv.KeyPoints.from_mediapipe`](/latest/keypoint/core/#metavision.keypoint.core.KeyPoints.from_mediapipe)
