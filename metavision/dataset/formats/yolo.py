...
from metavision.dataset.utils import approximate_mask_with_polygons
from metavision.detection.core import Detections
from metavision.detection.utils import polygon_to_mask, polygon_to_xyxy
from metavision.utils.file import (
...
if TYPE_CHECKING:
    from metavision.dataset.core import DetectionDataset
