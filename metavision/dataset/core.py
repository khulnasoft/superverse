...
from metavision.utils.internal import deprecated, warn_deprecated
from metavision.utils.iterables import find_duplicates
...
class DetectionDataset(BaseDataset):
    ...
    def __init__(
        ...
        if isinstance(images, dict):
            ...
            warn_deprecated(
                ...
                "deprecated and will be removed in `metavision-0.26.0`. Use "
                "a list of paths `List[str]` instead."
            )
            # TODO: when metavision-0.26.0 is released, and Dict[str, np.ndarray]
    ...
    @deprecated(
        ...
        "`metavision-0.26.0`. Iterate with `for path, image, annotation in dataset:` "
        "instead."
    )
