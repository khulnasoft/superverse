...
from metavision.metrics.core import Metric, MetricTarget
...
class MeanAveragePrecision(Metric):
    ...
    Example:
        ...
        from metavision.metrics import MeanAveragePrecision
    ...
    ![example_plot](\
        https://media.khulnasoft.com/metavision-docs/metrics/mAP_plot_example.png\
