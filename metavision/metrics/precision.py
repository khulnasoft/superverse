...
from metavision.config import ORIENTED_BOX_COORDINATES
...
from metavision.draw.color import LEGACY_COLOR_PALETTE
from metavision.metrics.core import AveragingMethod, Metric, MetricTarget
from metavision.metrics.utils.object_size import (
    ObjectSizeCategory,
    get_detection_size_category,
)
from metavision.metrics.utils.utils import ensure_pandas_installed
...
class Precision(Metric):
    ...
    Example:
        ...
        from metavision.metrics import Precision
    ...
    ![example_plot](\
        https://media.khulnasoft.com/metavision-docs/metrics/precision_plot_example.png\
